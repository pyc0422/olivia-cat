...
export function saveStoredCurrentUser(user) {
  ...
  const snapshot = {
    ...
    kitty_bucks: Number.isFinite(user.kitty_bucks) ? user.kitty_bucks : Number(user.user_metadata?.kitty_bucks || 0),
    avatar_unlocks: user.avatar_unlocks || user.user_metadata?.avatar_unlocks || {},
    ...
    avatar_accessory: user.user_metadata?.avatar_accessory || "none",
